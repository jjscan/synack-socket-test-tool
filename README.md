...
[**Releases**](https://github.com/jjscan/synack-socket-test-tool/releases/latest) 에서 `SYNACK_Setup_v2.1.0.exe` 를 받아 실행하면 됩니다.
...
| [qa/README.md](qa/README.md) | 검증 하네스 실행 방법 (기능 199개 / 부하 60개) |
